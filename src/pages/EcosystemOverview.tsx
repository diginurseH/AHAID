          ...
          <section id="overview" className="py-12">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h1 className="text-4xl md:text-5xl font-bold">
                    <span className="text-secondary">Nursaera Health Tech</span> <span className="text-primary">Ecosystem</span>
                  </h1>
                </div>
              ...
              <div>
                <img 
                  src={ecosystemImage} 
                  alt="Nursaera Health Tech ecosystem workspace with African professionals" 
          ...
          <section id="join" className="py-12">
            <div className="bg-secondary text-secondary-foreground rounded-2xl p-8 text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">
                Join the Nursaera Health Tech Ecosystem
              </h3>
